...
type YOADeck struct {
	...
	MainDeckCards      []YOAMainDeckCard  `json:"main_deck_cards,omitempty" gorm:"foreignKey:DeckID"`
	ExtraDeckCards     []YOAExtraDeckCard `json:"main_extra_cards,omitempty" gorm:"foreignKey:DeckID"`
	SideDeckCards      []YOASideDeckCard  `json:"main_side_cards,omitempty" gorm:"foreignKey:DeckID"`
